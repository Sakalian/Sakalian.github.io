    ...
    <>
      <motion.nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          isScrolled 
            ? 'bg-gray-900/90 backdrop-blur-xl shadow-lg border-b border-white/20' 
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            ...
            <motion.div
              className="fixed top-16 left-4 right-4 bg-gray-900/90 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 overflow-hidden"
